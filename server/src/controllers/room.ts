...
import { roomCreate, roomFind } from '../service/room.js'
import { userJoinRoom, userLeaveRoom } from '../service/user.js'
...
router.put('/:code/join', async (req: express.Request, res: express.Response) => {
    try {
...
router.put('/:code/leave', async (req: express.Request, res: express.Response) => {
    try {
